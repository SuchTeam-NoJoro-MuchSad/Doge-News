    ...
    public class NewsDataSourceServiceTest
    {
        ...
        public void Constructor_ShouldThrowArgumentNullExceptionWhenNewsItemRepoIsNull()
        {
            var exception = Assert.Throws<ArgumentNullException>(() =>
                new NewsDataSourceService(null, mockedMapperProvider.Object));
        ...
        {
            var exception = Assert.Throws<ArgumentNullException>(() =>
                new NewsDataSourceService(mockedNewsRepo.Object, null));
        ...
        {
            var service = new NewsDataSourceService(this.mockedNewsRepo.Object, this.mockedMapperProvider.Object);
            var exception = Assert.Throws<ArgumentOutOfRangeException>(() => service.OrderByDateDescending(page, 20));
        ...
        {
            var service = new NewsDataSourceService(this.mockedNewsRepo.Object, this.mockedMapperProvider.Object);
            var exception = Assert.Throws<ArgumentOutOfRangeException>(() => service.OrderByDateDescending(20, pageSize));
        ...
        public void OrderByDateDescending_ShouldReturnCorrectElements()
        {
            ...
            var expected = this.newsItems
                ...
                .ToList();
            var actual = service.OrderByDateDescending(1, 6);
        ...
        {
            var service = new NewsDataSourceService(this.mockedNewsRepo.Object, this.mockedMapperProvider.Object);
            var exception = Assert.Throws<ArgumentOutOfRangeException>(() => service.OrderByDateAscending(page, 20));
        ...
        {
            var service = new NewsDataSourceService(this.mockedNewsRepo.Object, this.mockedMapperProvider.Object);
            var exception = Assert.Throws<ArgumentOutOfRangeException>(() => service.OrderByDateAscending(20, pageSize));
        ...
        public void OrderByDateAscending_ShouldReturnCorrectElements()
        {
            ...
            var expected = this.newsItems
                ...
                .Select(x => new NewsWebModel { CreatedOn = x.CreatedOn })
                .ToList();
            var actual = service.OrderByDateAscending(1, 6);
