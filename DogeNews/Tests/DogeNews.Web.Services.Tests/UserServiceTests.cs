...
namespace DogeNews.Web.Services.Tests
{
    ...
    public class UserServiceTests
    {
        ...
        [TestCase(null)]
        [TestCase("")]
        public void ChangePassword_WhenUsernameIsNullOrEmptyArgumentNullExceptionsShouldBeThrown(string username)
        {
            ...
            var exception = Assert.Throws<ArgumentNullException>(() => userService.ChangePassword(username, "password"));
            Assert.AreEqual("username", exception.ParamName);
        }

        [TestCase(null)]
        [TestCase("")]
        public void ChangePassword_WhenPasswordIsNullOrEmptyArgumentNullExceptionsShouldBeThrown(string newPassword)
        {
            var userService = new UserService(
                    this.mockedUserRepository.Object,
                    this.mockedCryptographicService.Object,
            ...
            var exception = Assert.Throws<ArgumentNullException>(() => userService.ChangePassword("username", newPassword));
            Assert.AreEqual("newPassword", exception.ParamName);
        }
