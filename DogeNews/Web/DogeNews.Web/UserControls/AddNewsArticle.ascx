<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddNewsArticle.ascx.cs" Inherits="DogeNews.Web.UserControls.AddNewsArticle" %>
...
<asp:UpdatePanel runat="server">
    <ContentTemplate>
        <div class="container" id="add-news-main">
            <div class="row flex-container col s12">
    ...
    <Triggers>
        <asp:PostBackTrigger ControlID="add_news_submit_btn" />
    </Triggers>
</asp:UpdatePanel>
